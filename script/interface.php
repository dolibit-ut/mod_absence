...
function _get(&$ATMdb, $case) {
	switch ($case) {
		...
		case 'planning':
			...
			if(isset($_REQUEST['date_debut_search'])) $absence->date_debut_planning = $_REQUEST['date_debut_search']; 
			if(isset($_REQUEST['date_fin_search'])) $absence->date_fin_planning = $_REQUEST['date_fin_search']; 

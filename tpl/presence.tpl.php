	...
	[onshow;block=begin;when [view.mode]=='view']
     ...
     [onshow;block=end]
			...
			<table class="border" style="width:100%">
				...
				[onshow;block=begin;when [view.mode]!='edit']
				[onshow;block=begin;when [absenceCourante.isPresenceHour]=='0']
				<tr>
				...
				[onshow;block=end]
				[onshow;block=begin;when [absenceCourante.isPresenceHour]=='1']
				<tr>
					<td>[translate.Date;strconv=no]</td>
					<td>[absenceCourante.date_single;strconv=no;protect=no]</td>
				</tr>
				<tr>
					<td>[translate.DurationInHours;strconv=no]</td>
